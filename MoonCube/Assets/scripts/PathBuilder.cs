...
public class PathBuilder {
	public List<Cell> genomes;
	public List<Cell> lastGenerationGenomes;
	...
	public MazeMaker mazeController;
	public MazeMaker mazeControllerDisplay;
	public bool busy;

	public PathBuilder() {
		busy = false;
		genomes = new List<Cell> ();
		lastGenerationGenomes = new List<Cell> ();
	}
	...
	public Cell RouletteWheelSelection() {
	...
	public void CreateStartPopulation() {
		...
		for (int i = 0; i < populationSize; i++) {
			Cell baby = new Cell (chromosomeLength);
			genomes.Add (baby);
		}
	}
	...
	public void Epoch() {
		...
		List<Cell> babies = new List<Cell> ();
		while (numberOfNewBabies < populationSize) {
			// select 2 parents
			Cell mom = RouletteWheelSelection ();
			Cell dad = RouletteWheelSelection ();
			Cell baby1 = new Cell();
			Cell baby2 = new Cell();
